...
// Read API URL from environment variable for Vercel / production deployments
// Defaults to empty string in development so requests use the Vite dev server proxy
const BACKEND_URL = (import.meta.env.VITE_API_URL || '').replace(/\/$/, '');
const API_BASE = `${BACKEND_URL}/api/subscriptions`;
